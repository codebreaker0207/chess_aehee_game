...
const names = {
  ...
  "2": { "1": ["고선", "김연우", "김의혁", "노재하", "문윤슬", "박강률", "박민서", "신동훈", "신세호", "심성민", "심유찬", "안태준", "오주은", "우주원", "윤화인", "이가영", "이다민", "이도현", "이선규", "이송하", "이예준", "이태은", "이형준", "임봄", "장서윤", "하남윤", "한준서", "정유은"],
         ...
         "7": ["강별","강승호","권이현","권혁","김민재","김주석","남현우","박수민","박주아ㅗ","박지후","박해원","서동현","안현진","원도현","윤현수","이무헌","이윤아","이지환","이하진","이해인","임재이","임지희","조안나","조은빈","최선요","최유정","최정윤","황유진"],
         "9": ["곽유인","김동현","김유담","김준민","김차율","김태우","나동윤","나성혁","문서이","박성진","박소현","박채연","빙가율","서유찬","소이현","송민지","신지윤","우성민","유승민","육나경","이유미노","임유빈","장미송","최요엘","최지수","김준후"]},
